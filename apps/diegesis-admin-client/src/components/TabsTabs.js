...
export default function TabsTabs({selectedTabIndex, setSelectedTabIndex, selectedOrg}) {
    ...
    return <Tabs size="small" value={selectedTabIndex} onChange={handleChange} aria-label="local/remote tabs">
        ...
        <Tab icon={<CloudSync/>} id="simple-tab-2" aria-controls="simple-tabpanel-2" disabled={selectedOrg === "DBL"}/>
    </Tabs>
}
