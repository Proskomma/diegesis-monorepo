...
export default function ListViewController({searchTerms,searchIcons}) {
    ...
    return <Grid container>
        <Grid item xs={12} sm={12} md={2} sx={{paddingBottom: "15px"}}>
            <OrgSelector
                ...
                disabled={!searchIcons.includes("org")}
            />
        </Grid>
        <Grid dir={directionText(appLang)} item xs={12} sm={6} md={1}>
            <TextField
                ...
                disabled = {!searchIcons.includes("owner")}
            />
        </Grid>
        <Grid item xs={12} sm={6} md={2}>
            <TextField
                ...
                color="primary"
                sx={{display: 'flex', marginLeft: "1em"}}
                disabled = {!searchIcons.includes("type")}
            />
        </Grid>
        <Grid item xs={12} sm={6} md={1}>
            <TextField
                ...
                color="primary"
                sx={{display: 'flex', marginLeft: "1em"}}
                disabled = {!searchIcons.includes("lang")}
            />
        </Grid>
        <Grid item xs={12} sm={6} md={2}>
            <TextField
                ...
                color="primary"
                sx={{display: 'flex', marginLeft: "1em"}}
                disabled = {!searchIcons.includes("title")}
            />
        </Grid>
