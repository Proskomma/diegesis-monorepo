...
export default function Footer() {
    ...
    return <Box style={{marginTop:"5%"}} dir={directionText(appLang)} id="footer" sx={{backgroundColor: "primary.main", color: "#FFF", p: 3}}>
        <Typography variant="body2" style={{ fontFamily : fontFamily(appLang)}}>{i18n(appLang,'FOOTER_START')}
        ...
        <Typography variant="body2" style={{ fontFamily : fontFamily(appLang)}}>© MVH Solutions 2023</Typography>
    </Box>
}
