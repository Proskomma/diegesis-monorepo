...
import {alignmentText, directionText, FontFamily,} from "../i18n/languageDirection";
...
export default function PrintModal({
  ...
  const makeIncludedFlags = (allN, includedN) => {
    ...
    const onPrintClick = () => {
        const paras = printModalResources.doRender({pk, scriptureData: makeIncludedFlags(allNames, includedNames), docId});
                    ...
                    <Box sx={printModalStyle}>
                        ...
                        >
                            <Grid item sx={{margin: "2%"}}>
                                ...
                                >
                                    <InputLabel id="included-content-group-label">
