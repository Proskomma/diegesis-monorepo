...
export default function EntryDownloadPage({setAppLanguage}) {
    ...
    return <Container fixed className="homepage">
        ...
        <Box dir={directionText(appLang)} style={{marginTop: "100px"}}>
            ...
            <Grid container>
                <Grid item xs={12}>
                    <Typography variant="h5" paragraph="true" style={{ fontFamily : setFontFamily(appLang)}}>{i18n(appLang, "ADMIN_DOWNLOAD_PAGE_TITLE")}</Typography>
                </Grid>
                {
                    entryInfo.canonResources && entryInfo.canonResources
                        ...
                        .map(
                            cr => <>
                                <Grid item xs={4}>
                                    <Typography variant="body1" paragraph="true" style={{ fontFamily : setFontFamily(appLang)}}>{cr}</Typography>
                                </Grid>
                                <Grid item xs={8}>
                    ...
                    <>
                        <Grid item xs={4} md={2}>
                            <Typography variant="h5"
                                        paragraph="true" style={{ fontFamily : setFontFamily(appLang)}}>{i18n(appLang, "ADMIN_DOWNLOAD_PAGE_STITLE")}</Typography>
                        </Grid>
